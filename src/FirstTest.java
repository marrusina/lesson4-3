...
public class FirstTest {
    ...
    @Test
    public void testChangeScreenOrientationFromLastTest() {

        ScreenOrientation check_orientation = driver.getOrientation();
        if (check_orientation != ScreenOrientation.PORTRAIT) {
